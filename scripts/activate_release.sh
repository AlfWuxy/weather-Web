...
# 低内存生产机的 Flask 冷启动实测会超过 5 秒；保留单次硬上限并预留抖动余量。
FORMAL_SMOKE_LEASE_ATTEMPT_TIMEOUT_SECONDS="${FORMAL_SMOKE_LEASE_ATTEMPT_TIMEOUT_SECONDS:-15}"
QWEATHER_BUDGET_SNAPSHOT_TIMEOUT_SECONDS="${QWEATHER_BUDGET_SNAPSHOT_TIMEOUT_SECONDS:-15}"
...
EXPECTED_REQUIREMENTS_LOCK_SHA256="b3333fa96ec467479079e05f82f27f744b83147268e338383878c3c12ffd4452"
