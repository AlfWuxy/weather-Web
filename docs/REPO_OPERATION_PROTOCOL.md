...
1. 在 Notion“网站迭代库”里确认本轮条目
2. 从 `main` 拉出分支
3. 小步提交
4. 提 Draft PR
5. 写清楚“改了什么 / 为什么改 / 怎么验证”
6. 验证通过后使用 squash merge
7. 回填 Notion 的分支名、PR 链接和验证结果
...
4. 如果发现当前工作区已经有别的未提交改动，优先用独立 `worktree` 或独立副本处理。
5. 如果本轮目标是“让仓库更干净”，优先删噪音文档、重复副本和一次性记录，不碰运行链路。
