...
1. **一条主路径**：今天风险 → 提醒家人 → 记录是否做到 → 附近避暑。Web 主导航保持「今天 / 照护 / 7 天 / 社区风险 / 老人模式」；研究分析（AI 提问、慢病评估、疾病预测、年度报告、AI 悬浮）只留在管理员，路由已拦截。健康日记仍可直链，不在普通导航。小程序保持薄客户端：档案、预警、话术；打卡和避暑在网页完成。
