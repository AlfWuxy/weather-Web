...
> 版本：v2.2（2026-09-26）· 状态：已批准，P4 已完成 · 基线：`main@60ef21f`
...
| P4 服务层去重 | 4a、4b、4c、4d、4e、4f、4h（明细见 5.1 末尾） | 产品代码 +120 / -555，净减 435 行；`main` 与 PR 零差异，共 2193 个检查点 |

产品代码合计净减 1658 行（P0 到 P3 净减 1223 行，P4 净减 435 行）。原有 417 个默认测试、10 个手工契约测试均通过。
...
| 2 | P4 服务层 | 场景锁、数据库快照、冬季时间点 | 已完成，-435 行 |
